...
@EnableJpaRepositories(basePackages = {"dev.ohhoonim.factory.infra.business"},
...
public class BusinessDatasourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean businessEntityManagerFactory(
        ...
        return builder.dataSource(businessDatasource).packages("dev.ohhoonim.factory.infra.business")
