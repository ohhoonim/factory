...
@EnableJpaRepositories(basePackages = {"dev.ohhoonim.factory.infra.personal"},
...
public class PersonalDatasourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean personalEntityManagerFactory(
        ...
        return builder.dataSource(personalDatasource).packages("dev.ohhoonim.factory.infra.personal")
